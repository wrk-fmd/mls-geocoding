...
COPY  ./pom.xml                      ./
COPY  ./geocoding-api/pom.xml        ./geocoding-api/
COPY  ./geocoding-gmaps/pom.xml      ./geocoding-gmaps/
COPY  ./geocoding-poi/pom.xml        ./geocoding-poi/
COPY  ./geocoding-transform/pom.xml  ./geocoding-transform/
COPY  ./geocoding-vienna/pom.xml     ./geocoding-vienna/
COPY  ./geocoding-worker/pom.xml     ./geocoding-worker/
